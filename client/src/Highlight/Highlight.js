...
const Highlight = () => (
  <div className='TFB-container' style={{display:'inline-block'}}>
    <Col className='TFB-col' xs={12} sm={6}>
      ...
      <div className='TFB-p'>
        <p>Voluntourism Programs - In partnership with Better Life Vietnam and Viet Dan, tourists can engage in community work and gain an immersive look into Vietnamese culture in exchange.</p>
